...
defmodule MergeATSClient.Api.Scorecards do
  ...
  """
  @spec scorecards_create(Tesla.Env.client, String.t, String.t, keyword()) :: {:ok, MergeATSClient.Model.Scorecard.t} | {:error, Tesla.Env.t}
  def scorecards_create(connection, authorization, x_account_token, opts \\ []) do
    optional_params = %{
