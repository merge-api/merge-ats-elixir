...
defmodule Mergee.Model.RemoteUser do
  @moduledoc """
...
defimpl Poison.Decoder, for: Mergee.Model.RemoteUser do
  import Mergee.Deserializer
  def decode(value, options) do
    value
    |> deserialize(:"access_role", :struct, Mergee.Model.AccessRoleEnum, options)
  end
end
