...
defmodule Mergee.Api.Activities do
  @moduledoc """
  ...
  {:ok, %Mergee.Model.PaginatedActivityList{}} on success
  {:error, info} on failure
  """
  @spec activities_list(Tesla.Env.client, String.t, keyword()) :: {:ok, Mergee.Model.PaginatedActivityList.t} | {:error, Tesla.Env.t}
  def activities_list(connection, x_account_token, opts \\ []) do
    ...
    |> evaluate_response([
      { 200, %Mergee.Model.PaginatedActivityList{}}
    ])
  end
  ...
  {:ok, %Mergee.Model.Activity{}} on success
  {:error, info} on failure
  """
  @spec activities_retrieve(Tesla.Env.client, String.t, String.t, keyword()) :: {:ok, Mergee.Model.Activity.t} | {:error, Tesla.Env.t}
