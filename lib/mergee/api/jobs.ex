...
defmodule Mergee.Api.Jobs do
  ...
  {:ok, %Mergee.Model.PaginatedJobList{}} on success
  {:error, info} on failure
  """
  @spec jobs_list(Tesla.Env.client, String.t, keyword()) :: {:ok, Mergee.Model.PaginatedJobList.t} | {:error, Tesla.Env.t}
  def jobs_list(connection, x_account_token, opts \\ []) do
    ...
    |> evaluate_response([
      { 200, %Mergee.Model.PaginatedJobList{}}
    ])
  end
  ...
  {:ok, %Mergee.Model.Job{}} on success
  {:error, info} on failure
  """
  @spec jobs_retrieve(Tesla.Env.client, String.t, String.t, keyword()) :: {:ok, Mergee.Model.Job.t} | {:error, Tesla.Env.t}
