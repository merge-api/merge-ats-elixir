...
defmodule Mergee.Api.Scorecards do
  @moduledoc """
  ...
  {:ok, %Mergee.Model.PaginatedScorecardList{}} on success
  {:error, info} on failure
  """
  @spec scorecards_list(Tesla.Env.client, String.t, keyword()) :: {:ok, Mergee.Model.PaginatedScorecardList.t} | {:error, Tesla.Env.t}
  def scorecards_list(connection, x_account_token, opts \\ []) do
    ...
    |> evaluate_response([
      { 200, %Mergee.Model.PaginatedScorecardList{}}
    ])
  end
  ...
  {:ok, %Mergee.Model.Scorecard{}} on success
  {:error, info} on failure
  """
  @spec scorecards_retrieve(Tesla.Env.client, String.t, String.t, keyword()) :: {:ok, Mergee.Model.Scorecard.t} | {:error, Tesla.Env.t}
