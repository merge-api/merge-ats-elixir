...
defmodule Mergee.Api.Attachments do
  @moduledoc """
  ...
  {:ok, %Mergee.Model.PaginatedAttachmentList{}} on success
  {:error, info} on failure
  """
  @spec attachments_list(Tesla.Env.client, String.t, keyword()) :: {:ok, Mergee.Model.PaginatedAttachmentList.t} | {:error, Tesla.Env.t}
  def attachments_list(connection, x_account_token, opts \\ []) do
    ...
    |> evaluate_response([
      { 200, %Mergee.Model.PaginatedAttachmentList{}}
    ])
  end
  ...
  {:ok, %Mergee.Model.Attachment{}} on success
  {:error, info} on failure
  """
  @spec attachments_retrieve(Tesla.Env.client, String.t, String.t, keyword()) :: {:ok, Mergee.Model.Attachment.t} | {:error, Tesla.Env.t}
