...
defmodule Mergee.Api.Offices do
  @moduledoc """
  ...
  {:ok, %Mergee.Model.PaginatedOfficeList{}} on success
  {:error, info} on failure
  """
  @spec offices_list(Tesla.Env.client, String.t, keyword()) :: {:ok, Mergee.Model.PaginatedOfficeList.t} | {:error, Tesla.Env.t}
  def offices_list(connection, x_account_token, opts \\ []) do
    ...
    |> evaluate_response([
      { 200, %Mergee.Model.PaginatedOfficeList{}}
    ])
  end
  ...
  {:ok, %Mergee.Model.Office{}} on success
  {:error, info} on failure
  """
  @spec offices_retrieve(Tesla.Env.client, String.t, String.t, keyword()) :: {:ok, Mergee.Model.Office.t} | {:error, Tesla.Env.t}
