...
defmodule MergeATSAPI.Model.Scorecard do
  @moduledoc """
...
defimpl Poison.Decoder, for: MergeATSAPI.Model.Scorecard do
  import MergeATSAPI.Deserializer
  def decode(value, options) do
    value
    |> deserialize(:"overall_recommendation", :struct, MergeATSAPI.Model.OverallRecommendationEnum, options)
  end
end
