...
defmodule MergeATSAPI.Model.Job do
  @moduledoc """
...
defimpl Poison.Decoder, for: MergeATSAPI.Model.Job do
  import MergeATSAPI.Deserializer
  def decode(value, options) do
    value
    |> deserialize(:"status", :struct, MergeATSAPI.Model.JobStatusEnum, options)
  end
end
