...
defmodule MergeATSAPI.Model.PhoneNumber do
  @moduledoc """
...
defimpl Poison.Decoder, for: MergeATSAPI.Model.PhoneNumber do
  import MergeATSAPI.Deserializer
  def decode(value, options) do
    value
    |> deserialize(:"phone_number_type", :struct, MergeATSAPI.Model.PhoneNumberTypeEnum, options)
  end
end
