...
defmodule MergeATSAPI.Api.Attachments do
  @moduledoc """
  ...
  {:ok, %MergeATSAPI.Model.PaginatedAttachmentList{}} on success
  {:error, info} on failure
  """
  @spec attachments_list(Tesla.Env.client, String.t, keyword()) :: {:ok, MergeATSAPI.Model.PaginatedAttachmentList.t} | {:error, Tesla.Env.t}
  def attachments_list(connection, x_account_token, opts \\ []) do
    ...
    |> evaluate_response([
      { 200, %MergeATSAPI.Model.PaginatedAttachmentList{}}
    ])
  end
  ...
  {:ok, %MergeATSAPI.Model.Attachment{}} on success
  {:error, info} on failure
  """
  @spec attachments_retrieve(Tesla.Env.client, String.t, String.t, keyword()) :: {:ok, MergeATSAPI.Model.Attachment.t} | {:error, Tesla.Env.t}
  def attachments_retrieve(connection, x_account_token, id, _opts \\ []) do
    ...
    |> (&Connection.request(connection, &1)).()
    |> evaluate_response([
      { 200, %MergeATSAPI.Model.Attachment{}}
    ])
  end
end
