...
defmodule MergeATSAPI.Api.Candidates do
  @moduledoc """
  ...
  {:ok, %MergeATSAPI.Model.PaginatedCandidateList{}} on success
  {:error, info} on failure
  """
  @spec candidates_list(Tesla.Env.client, String.t, keyword()) :: {:ok, MergeATSAPI.Model.PaginatedCandidateList.t} | {:error, Tesla.Env.t}
  def candidates_list(connection, x_account_token, opts \\ []) do
    ...
    |> evaluate_response([
      { 200, %MergeATSAPI.Model.PaginatedCandidateList{}}
    ])
  end
  ...
  {:ok, %MergeATSAPI.Model.Candidate{}} on success
  {:error, info} on failure
  """
  @spec candidates_retrieve(Tesla.Env.client, String.t, String.t, keyword()) :: {:ok, MergeATSAPI.Model.Candidate.t} | {:error, Tesla.Env.t}
  def candidates_retrieve(connection, x_account_token, id, opts \\ []) do
    ...
    |> (&Connection.request(connection, &1)).()
    |> evaluate_response([
      { 200, %MergeATSAPI.Model.Candidate{}}
    ])
  end
end
