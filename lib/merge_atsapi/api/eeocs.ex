...
defmodule MergeATSAPI.Api.Eeocs do
  @moduledoc """
  ...
  {:ok, %MergeATSAPI.Model.PaginatedEeocList{}} on success
  {:error, info} on failure
  """
  @spec eeocs_list(Tesla.Env.client, String.t, keyword()) :: {:ok, MergeATSAPI.Model.PaginatedEeocList.t} | {:error, Tesla.Env.t}
  def eeocs_list(connection, x_account_token, opts \\ []) do
    ...
    |> evaluate_response([
      { 200, %MergeATSAPI.Model.PaginatedEeocList{}}
    ])
  end
  ...
  {:ok, %MergeATSAPI.Model.Eeoc{}} on success
  {:error, info} on failure
  """
  @spec eeocs_retrieve(Tesla.Env.client, String.t, String.t, keyword()) :: {:ok, MergeATSAPI.Model.Eeoc.t} | {:error, Tesla.Env.t}
