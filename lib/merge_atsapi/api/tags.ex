...
defmodule MergeATSAPI.Api.Tags do
  @moduledoc """
  ...
  {:ok, %MergeATSAPI.Model.PaginatedTagList{}} on success
  {:error, info} on failure
  """
  @spec tags_list(Tesla.Env.client, String.t, keyword()) :: {:ok, MergeATSAPI.Model.PaginatedTagList.t} | {:error, Tesla.Env.t}
  def tags_list(connection, x_account_token, opts \\ []) do
    ...
    |> evaluate_response([
      { 200, %MergeATSAPI.Model.PaginatedTagList{}}
    ])
  end
end
