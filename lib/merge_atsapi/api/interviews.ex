...
defmodule MergeATSAPI.Api.Interviews do
  @moduledoc """
  ...
  {:ok, %MergeATSAPI.Model.PaginatedScheduledInterviewList{}} on success
  {:error, info} on failure
  """
  @spec interviews_list(Tesla.Env.client, String.t, keyword()) :: {:ok, MergeATSAPI.Model.PaginatedScheduledInterviewList.t} | {:error, Tesla.Env.t}
  def interviews_list(connection, x_account_token, opts \\ []) do
    ...
    |> evaluate_response([
      { 200, %MergeATSAPI.Model.PaginatedScheduledInterviewList{}}
    ])
  end
  ...
  {:ok, %MergeATSAPI.Model.ScheduledInterview{}} on success
  {:error, info} on failure
  """
  @spec interviews_retrieve(Tesla.Env.client, String.t, String.t, keyword()) :: {:ok, MergeATSAPI.Model.ScheduledInterview.t} | {:error, Tesla.Env.t}
  def interviews_retrieve(connection, x_account_token, id, opts \\ []) do
    ...
    |> (&Connection.request(connection, &1)).()
    |> evaluate_response([
      { 200, %MergeATSAPI.Model.ScheduledInterview{}}
    ])
  end
end
