...
defmodule MergeATSAPI.Api.Applications do
  @moduledoc """
  ...
  {:ok, %MergeATSAPI.Model.PaginatedApplicationList{}} on success
  {:error, info} on failure
  """
  @spec applications_list(Tesla.Env.client, String.t, keyword()) :: {:ok, MergeATSAPI.Model.PaginatedApplicationList.t} | {:error, Tesla.Env.t}
  def applications_list(connection, x_account_token, opts \\ []) do
    ...
    |> evaluate_response([
      { 200, %MergeATSAPI.Model.PaginatedApplicationList{}}
    ])
  end
  ...
  {:ok, %MergeATSAPI.Model.Application{}} on success
  {:error, info} on failure
  """
  @spec applications_retrieve(Tesla.Env.client, String.t, String.t, keyword()) :: {:ok, MergeATSAPI.Model.Application.t} | {:error, Tesla.Env.t}
  def applications_retrieve(connection, x_account_token, id, opts \\ []) do
    ...
    |> (&Connection.request(connection, &1)).()
    |> evaluate_response([
      { 200, %MergeATSAPI.Model.Application{}}
    ])
  end
end
