...
defmodule MergeATSAPI.Api.RejectReasons do
  @moduledoc """
  ...
  {:ok, %MergeATSAPI.Model.PaginatedRejectReasonList{}} on success
  {:error, info} on failure
  """
  @spec reject_reasons_list(Tesla.Env.client, String.t, keyword()) :: {:ok, MergeATSAPI.Model.PaginatedRejectReasonList.t} | {:error, Tesla.Env.t}
  def reject_reasons_list(connection, x_account_token, opts \\ []) do
    ...
    |> evaluate_response([
      { 200, %MergeATSAPI.Model.PaginatedRejectReasonList{}}
    ])
  end
  ...
  {:ok, %MergeATSAPI.Model.RejectReason{}} on success
  {:error, info} on failure
  """
  @spec reject_reasons_retrieve(Tesla.Env.client, String.t, String.t, keyword()) :: {:ok, MergeATSAPI.Model.RejectReason.t} | {:error, Tesla.Env.t}
  def reject_reasons_retrieve(connection, x_account_token, id, _opts \\ []) do
    ...
    |> (&Connection.request(connection, &1)).()
    |> evaluate_response([
      { 200, %MergeATSAPI.Model.RejectReason{}}
    ])
  end
end
