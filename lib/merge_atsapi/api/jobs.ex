...
defmodule MergeATSAPI.Api.Jobs do
  @moduledoc """
  ...
  {:ok, %MergeATSAPI.Model.PaginatedJobList{}} on success
  {:error, info} on failure
  """
  @spec jobs_list(Tesla.Env.client, String.t, keyword()) :: {:ok, MergeATSAPI.Model.PaginatedJobList.t} | {:error, Tesla.Env.t}
  def jobs_list(connection, x_account_token, opts \\ []) do
    optional_params = %{
      :"created_after" => :query,
    ...
    |> evaluate_response([
      { 200, %MergeATSAPI.Model.PaginatedJobList{}}
    ])
  end
  ...
  {:ok, %MergeATSAPI.Model.Job{}} on success
  {:error, info} on failure
  """
  @spec jobs_retrieve(Tesla.Env.client, String.t, String.t, keyword()) :: {:ok, MergeATSAPI.Model.Job.t} | {:error, Tesla.Env.t}
  def jobs_retrieve(connection, x_account_token, id, opts \\ []) do
    optional_params = %{
      :"expand" => :query
    }
    %{}
