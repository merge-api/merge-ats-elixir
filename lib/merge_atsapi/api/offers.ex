...
defmodule MergeATSAPI.Api.Offers do
  @moduledoc """
  ...
  {:ok, %MergeATSAPI.Model.PaginatedOfferList{}} on success
  {:error, info} on failure
  """
  @spec offers_list(Tesla.Env.client, String.t, keyword()) :: {:ok, MergeATSAPI.Model.PaginatedOfferList.t} | {:error, Tesla.Env.t}
  def offers_list(connection, x_account_token, opts \\ []) do
    ...
    |> evaluate_response([
      { 200, %MergeATSAPI.Model.PaginatedOfferList{}}
    ])
  end
  ...
  {:ok, %MergeATSAPI.Model.Offer{}} on success
  {:error, info} on failure
  """
  @spec offers_retrieve(Tesla.Env.client, String.t, String.t, keyword()) :: {:ok, MergeATSAPI.Model.Offer.t} | {:error, Tesla.Env.t}
